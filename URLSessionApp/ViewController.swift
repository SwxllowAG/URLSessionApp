        ...
        session.dataTask(with: url!) { (data, _, error) in
            ...
            do {
                ...
                for item in items {
                    ...
                    let thumbnail = (info["imageLinks"] as! [String: String])["thumbnail"]
                    let description = info["description"] as! String
                    let publishedDate = info["publishedDate"] as! String
                    let book = Book(title: title, authors: authors, smallThumbnail: smallThumbnail, thumbnail: thumbnail, description: description, publishedDate: publishedDate)
